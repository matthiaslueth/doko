...
file_put_contents ('spieler1.txt', json_encode($spieler1));
file_put_contents ('spieler2.txt', json_encode($spieler2));
file_put_contents ('spieler3.txt', json_encode($spieler3));
file_put_contents ('spieler4.txt', json_encode($spieler4));

file_put_contents ('stapel1.txt', "");
file_put_contents ('stapel2.txt', "");
file_put_contents ('stapel3.txt', "");
file_put_contents ('stapel4.txt', "");

file_put_contents ('tisch.txt', "");
